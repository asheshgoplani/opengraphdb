...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_70%_55%_at_50%_30%,hsl(var(--primary)/0.18),transparent_70%)]" />
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_50%_40%_at_85%_85%,hsl(var(--accent)/0.12),transparent_70%)]" />
      ...
      >
        ...
        <h1
          id="hero-heading"
          className={`font-display text-balance text-5xl font-light leading-[0.95] text-foreground sm:text-7xl lg:text-[5.5rem] ${
            isInView ? 'animate-reveal-up animate-delay-100 animate-fill-both' : 'opacity-0'
          }`}
        >
          The single-file graph DB
          <br />
          <span className="italic text-foreground/85">Rust devs</span>
          <br />
          <span className="bg-gradient-to-r from-[hsl(var(--primary))] via-[hsl(var(--primary)/0.9)] to-[hsl(var(--accent))] bg-clip-text text-transparent">
            reach for.
          </span>
        </h1>

        <p
          className={`mx-auto mt-10 max-w-2xl text-pretty text-base leading-relaxed text-muted-foreground sm:text-lg ${
        ...
        >
          ...
          <Button
            ...
            variant="outline"
            size="lg"
            className="min-w-44 border-border bg-muted/40 text-foreground hover:bg-muted/60 hover:text-foreground"
          >
            <a
        ...
        <dl
          className={`mt-16 grid w-full max-w-xl grid-cols-3 gap-px overflow-hidden rounded-xl border border-border/60 bg-muted/40 ${
