...
- [x] **RAG-05**: MCP tools expose full RAG pipeline: browse_communities, drill_into_community, hybrid_search, ingest_document
...
- [x] **DEMO-AI-03**: Each AI response shows generated Cypher, query trace animation, and NL answer
