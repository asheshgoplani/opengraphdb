...
## AI-agent recipes (condensed from `docs/COOKBOOK.md`)
...
median, cold cache, 1 warmup pass discarded). Source of truth: [`docs/BENCHMARKS.md`](../../docs/BENCHMARKS.md).
...
- [`docs/BENCHMARKS.md`](../../docs/BENCHMARKS.md) — every cited number with reproducibility notes.
- [`docs/COOKBOOK.md`](../../docs/COOKBOOK.md) — seven full recipes (the inline mini-recipes above are condensed from this).
- [`docs/MIGRATION-FROM-NEO4J.md`](../../docs/MIGRATION-FROM-NEO4J.md) — five-minute migration brief.
- [`docs/AI-NATIVE-FEATURES.md`](../../docs/AI-NATIVE-FEATURES.md) — design notes for vector / agent-memory / GraphRAG.
- [`docs/ai-integration/llm-to-cypher.md`](../../docs/ai-integration/llm-to-cypher.md) — LLM → Cypher patterns.
- [`docs/ai-integration/embeddings-hybrid-rrf.md`](../../docs/ai-integration/embeddings-hybrid-rrf.md) — RRF math for hybrid retrieval.
- [`docs/ai-integration/multi-agent-shared-kg.md`](../../docs/ai-integration/multi-agent-shared-kg.md) — shared-KG patterns within today's single-writer constraints.
- [`docs/ai-integration/cosmos-mcp-tool.md`](../../docs/ai-integration/cosmos-mcp-tool.md) — MCP tool wiring.
